...
import 'package:my_app1/core/widgets/main_shell.dart';
...
import 'package:my_app1/features/search/ui/search_screen.dart';
...
class AppRouters {
  static final router = GoRouter(
    initialLocation: isLoggedInUser ? Routes.main : Routes.login,
    routes: [
      GoRoute(
