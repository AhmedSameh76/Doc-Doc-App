...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( T data)?  success,TResult Function( ErrorHandler errorHandler)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( T data)  success,required TResult Function( ErrorHandler errorHandler)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( T data)?  success,TResult? Function( ErrorHandler errorHandler)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $SearchStateCopyWith<T, $Res> {
...
class _Failure<T> implements SearchState<T> {
...
@override
String toString() {
  return 'SearchState<$T>.failure(errorHandler: $errorHandler)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $SearchStateCopyWith<T, $Res> {
